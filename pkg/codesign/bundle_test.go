...
func TestBundleRejectsUnsupportedLayout(t *testing.T) {
	for _, name := range []string{"extra", "Contents/Frameworks/F.unsupported/file", "Contents/CodeResources", "Contents/_CodeSignature/other", "Contents/_MASReceipt/receipt"} {

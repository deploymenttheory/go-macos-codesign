...
to `v0.3.2-0.20260920163104-022d800565d6`. Production reuses its exported
...
The same dependency now supplies the [standalone file metadata API](file-writes.md).

...
verification. Framework/plugin layouts and symlink/xattr policy remain next.
...
| Bundles and resources | Contents-based APPL discovery; XML/binary metadata; bounded graph decoding; deterministic v1/v2 CodeResources; nested Mach-O and APPL requirement seals; staged recursive signing, shared budgets and deep verification; native byte/mutation comparisons | Framework/plugin/XPC bundle layouts, symlink/xattr policy, wider discovery and requirement/digest variants, full strict verification |
